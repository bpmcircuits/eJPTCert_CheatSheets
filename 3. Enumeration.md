...
- *nmap* target *-sV -p 3306 --script=mysql-audit --script-args="mysql-audit.username='root',mysql-audit.password=' ', mysql-audit.filename='/usr/share/nselib/data/mysql-cis.audit'"* 

Enumeration for hashes:
- *nmap* target *-sV -p 3306 --script=mysql-dump-hashes --script-args="mysqluser='root',mysqlpass=' ' "* 
